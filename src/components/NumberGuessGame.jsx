...
const NumberGuessGame = () => {
    ...
    return (
        <div className="flex flex-col items-center gap-8 p-8 bg-white shadow-xl rounded-xl max-w-md">
            ...
            <input className="border border-gray-400 rounded-lg px-4 w-40 text-center focus:outline-none" 
            type="number" value={guess} onChange={(e) => setGuess(e.target.value)} disabled={isWin} />
            <button className="bg-blue-400 text-white px-6 py-2 rounded-lg hover:bg-blue-500 disabled:opacity-50"
            onClick={handleSubmit} disabled={isWin}>
                제출
            </button>
